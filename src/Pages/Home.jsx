        ...
        <div>
            ...
            <section className="flex flex-col-reverse items-center justify-center py-5 md:flex-row md:gap-7 bg-gradient-to-r from-amber-50 to-orange-300">
                <div className="w-4/6 ml-4 text-center md:w-2/6 md:text-left">
                    ...
                    <p className="pb-4 text-[#6B7280]">
                        The Pizza App lets you order you your favourite from the comfort of your home. 
            ...
            <section className="py-4 mt-6 bg-gradient-to-r from-amber-50 to-orange-300">
                <div className="container flex flex-col md:flex-row">
                    ...
                    <div className="flex flex-col flex-wrap tetx-center lg:py-6 lg:w-1/2 lg:pl-12 lg:text-left">
                                ...
                                <div className="flex flex-col items-center text-center p-4 md:w-1/3">
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <p className="text-base leading-relaxed">
                                            As easy as 1, 2, 3. Just select your favourite pizza and place order.
                                        </p>
                                    </div>
                                </div>
